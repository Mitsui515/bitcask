...
func TestAdaptiveRadixTree_Iterator(t *testing.T) {
	...
	art.Put([]byte("absq"), &data.LogRecordPos{Fid: 1, Offset: 12})
	art.Put([]byte("duqs"), &data.LogRecordPos{Fid: 1, Offset: 12})
	art.Put([]byte("bcde"), &data.LogRecordPos{Fid: 1, Offset: 12})
